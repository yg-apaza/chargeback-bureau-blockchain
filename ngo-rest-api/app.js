...
// GET Chargeback
app.get('/chargebacks', awaitHandler(async (req, res) => {
	logger.info('================ GET on Chargeback');
	let args = {};
	let fcn = "queryAllChargebacks";

    logger.info('##### GET on Chargeback - username : ' + username);
	logger.info('##### GET on Chargeback - userOrg : ' + orgName);
	logger.info('##### GET on Chargeback - channelName : ' + channelName);
	logger.info('##### GET on Chargeback - chaincodeName : ' + chaincodeName);
	logger.info('##### GET on Chargeback - fcn : ' + fcn);
	logger.info('##### GET on Chargeback - args : ' + JSON.stringify(args));
	logger.info('##### GET on Chargeback - peers : ' + peers);
...
app.get('/chargebacks/:chargebackId', awaitHandler(async (req, res) => {
	logger.info('================ GET on Chargeback by ID');
	logger.info('Chargeback id : ' + req.params);
	let args = req.params;
	let fcn = "queryChargeback";

    logger.info('##### GET on Chargeback by ID - username : ' + username);
	logger.info('##### GET on Chargeback by ID - userOrg : ' + orgName);
	logger.info('##### GET on Chargeback by ID - channelName : ' + channelName);
	logger.info('##### GET on Chargeback by ID - chaincodeName : ' + chaincodeName);
	logger.info('##### GET on Chargeback by ID - fcn : ' + fcn);
	logger.info('##### GET on Chargeback by ID - args : ' + JSON.stringify(args));
	logger.info('##### GET on Chargeback by ID - peers : ' + peers);
...
// POST Chargeback
app.post('/chargebacks', awaitHandler(async (req, res) => {
	logger.info('================ POST on Chargeback');
	var args = req.body;
	var fcn = "createChargeback";

    logger.info('##### POST on Chargeback - username : ' + username);
	logger.info('##### POST on Chargeback - userOrg : ' + orgName);
	logger.info('##### POST on Chargeback - channelName : ' + channelName);
	logger.info('##### POST on Chargeback - chaincodeName : ' + chaincodeName);
	logger.info('##### POST on Chargeback - fcn : ' + fcn);
	logger.info('##### POST on Chargeback - args : ' + JSON.stringify(args));
	logger.info('##### POST on Chargeback - peers : ' + peers);
